...
void create_new_root(Table* table, uint32_t right_child_page_num){
    /* 
    Handle splitting the root. Old root copied to new page, 
    becomes left child. Address of right child passed in.
   ...
   /* Insert each of the root’s keys into its new left child and update the parent pointer of each of those children */
